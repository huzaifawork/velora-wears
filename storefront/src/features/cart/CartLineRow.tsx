 ...
 *
 * Written once and rendered by BOTH the drawer and the cart page, with
 * `compact` changing the density and nothing else (section 18). The two
 * surfaces showing a line differently is how a mini bag and a full bag start
